...
export const styles = StyleSheet.create({
  ...
  fontWeight: "600",
  // remover marginLeft para alinhamento consistente
  fontFamily: 'InterRegular',
  },
  exportButtonSmall: {
    backgroundColor: Colors.brand.main,
    borderRadius: isWeb ? (isDesktop ? 12 : 10) : 8,
    paddingVertical: isWeb ? (isDesktop ? 12 : 10) : 10,
    paddingHorizontal: isWeb ? (isDesktop ? 18 : 16) : 14,
    alignItems: 'center',
    justifyContent: 'center',
    flexDirection: 'row',
    minHeight: isWeb ? 52 : 48,
    width: isWeb ? (isDesktop ? 160 : 140) : '48%',
    marginRight: isWeb ? (isDesktop ? 16 : 12) : 12,
  },
  addButton: {
