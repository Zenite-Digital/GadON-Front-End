...
export default function LoginScreen() {
    ...
    return (
        <ScrollView className="flex-1 bg-white px-6 justify-center font-inter-regular">
            ...
            <View className="mb-8">
                ...
                >
                    <Text className="font-bold text-base font-inter-medium" style={{ color: "#F3F3ED" }}>
                        Continuar
                    </Text>
                </TouchableOpacity>
            </View>
            ...
            <View className="flex-row items-center mb-6">
                ...
                <Text className="mx-4 text-slate-600 text-sm font-inter-regular">ou</Text>
                <View className="flex-1 h-px bg-gray-300" />
            </View>
